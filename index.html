...
<html lang="fr">
	<head>
		...
		<title>PAYMEQUICK - La solution de paiement universelle</title>
		<!-- Bootstrap CSS -->
		...
		<header class="header">
			<div class="container">
                ...
                <ul id="primary-menu">
                    ...
                    <li><a class="nav-link" href="#blog">Documentations</a></li>
                    <li><a class="nav-link" href="#contact">Contact</a></li>
                    <li><a class="appao-btn" href="https://play.google.com/store/apps/details?id=com.agis.payQuick&hl=fr">Télécharger</a></li>
                </ul>
					    </div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>PAYMEQUICK</h1>
              <p>La solution de paiement universelle <br>
                <a href="#">PAYMEQUICK</a> est une solution de paiement universelle permettant d'effectuer <br>
                des transaction allant du simple paiement aux services bancaire.<br>
                Avec la plateforme de paiement universelle <a href="#">PAYMEQUICK</a>, ne vous souciez plus <br> 
                des problèmes pour payer vos biens et services.</p>
							<a href="https://play.google.com/store/apps/details?id=com.agis.payQuick&hl=fr" class="appao-btn" target="_blank">Google Play Store</a>
		...
		<section class="about-area ptb-90">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>PAYMEQUICK<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
              <p>
                La solution de paiement universelle & la banque numérique simplifiée
				...
				<div class="row">
					<div class="col-lg-4">
					    <div class="single-about-box">
							...
							<h4>Confort et simplicité</h4>
							<p>PayMeQuick vous procure du confort avec son interface simple d'utilisation, Disponible depuis le PlayStore, avec une interface intuitive et simple d'utiisation, vous une experience utilisateur agréalble.</p>
						</div>
					</div>
					<div class="col-lg-4">
					    <div class="single-about-box active">
							<i class="icofont icofont-brand-fastrack"></i>
							<h4>Rapidité et flexibilité</h4>
							<p>Avec PayMeQuick la flexibilité est au rendez-vous, vous gagner en temps et vous ètes à l'abris du stress du manque de monaie car vous pouvez effectuer un paiement ou un rembousement en moins de 8 secondes. </p>
						</div>
					</div>
					<div class="col-lg-4">
					    <div class="single-about-box">
							<i class="icofont icofont-ssl-security"></i>
							<h4>Assurance et Sécurité</h4>
							<p>PayMeQuick est une plateforme ultra sécurisée. Les echanges qui on lieu entre les applications clientes et le serveur sont cryptées de bout en bout. Chez nous la sécurité de vos transactions est notre priorité.  </p>
						</div>
					</div>
				</div>
			</div>
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>Paiement des transactions</h4>
								...
								<li>
									<div class="feature-box-info">
										<h4>SOS Credit</h4>
										<p>Envoyer une demande d'aide ou contribuez aux aides sociale </p>
									</div>
									<div class="feature-box-icon">
								...
								<li>
									<div class="feature-box-info">
										<h4>Carte & comptes bancaire</h4>
										<p>Ajoutez vos comptes/cartes et payer sans stress </p>
									</div>
									<div class="feature-box-icon">
							...
							<ul>
								<li>
									...
									<div class="feature-box-info">
										...
										<p>Disponible sur 04 les plateformes mobiles les plus utilisées </p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										<h4>Retrait DAB/GAD</h4>
										<p>retirer votre argent depuis les GAD/DAB de nos partenaires </p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Transactions sécurités et utilisateurs protégés contre le vol d'informations </p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										<h4>Services de Banque</h4>
										<p>Tous les services de banques simplifiés et accessible à tous </p>
									</div>
								</li>
							</ul>
						</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<a href="#" class="appao-btn appao-btn2">Découvrir d'avantage</a>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="single-showcase-box">
				...
				<div class="row">
					<div class="col-lg-12">
					    <div class="video-popup">
							...
							<h1>Découvrir PAYMEQUICK en vidéo</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="download-area ptb-90">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>Télécharger PAYMEQUICK<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt </p>
						</div>
					</div>
				</div>
		...
		<section class="blog-area ptb-90" id="blog">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>Documentations & API<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt </p>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-4 col-md-6">
					    <div class="single-post">
							...
							<div class="post-details">
								...
								<h4 class="post-title"><a href="blog.html">PMQ FlashCash Payment</a></h4>
					...
					<div class="col-lg-4 col-md-6">
					    <div class="single-post">
							...
							<div class="post-details">
								...
								<h4 class="post-title"><a href="blog.html">PMQ QR Code Payment </a></h4>
								<p>Lorem ipsum dolor sit amet, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 d-md-none d-lg-block">
					    <div class="single-post">
							...
							<div class="post-details">
								...
								<h4 class="post-title"><a href="blog.html">PMQ Phone Payment</a></h4>
								<p>Lorem ipsum dolor sit amet, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad</p>
							</div>
						</div>
					</div>
                    ...
                    <div class="col-lg-6">
						<div class="contact-form">
							...
							<form id="contact-form" action="#" method="POST">
				                ...
				                <input type="text" name="subject" placeholder="Sujet d'echange">
						...
						<div class="contact-address">
							...
							<ul>
								...
								<li>
									...
									<div class="contact-address-info">
										<a href="mailto:info@paiemequick.com">info@paiemequick.com</a>
									</div>
								</li>
								<li>
									<div class="contact-address-icon">
									...
									<div class="contact-address-info">
										<a href="www.paiemequick.com">www.paiemequick.com</a>
									</div>
								</li>
							</ul>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="https://www.paiemequick.com" target="_blank">PAYMEQUICK</a>
